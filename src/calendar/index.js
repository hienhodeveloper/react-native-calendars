...
class Calendar extends Component {
  ...
  renderWeek(days, id) {
    ...
    let marginTop = this.props.theme.date.marginTop || 7;
    let marginBottom = this.props.theme.date.marginBottom || 7;
    let marginLeft = this.props.theme.date.marginLeft || 0;
    let marginRight = this.props.theme.date.marginRight || 0;
    return (<View style={[this.style.week, { marginTop, marginBottom, marginLeft, marginRight }]} key={id}>{week}</View>);
  }
